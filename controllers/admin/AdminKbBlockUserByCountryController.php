...
class AdminKbBlockUserByCountryController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->toolbar_title = $this->module->l('Knowband Block User by Country', 'AdminKbBlockUserByCountryController');
    }
    ...
    */
    public function initContent()
    {
        ...
        $this->context->smarty->assign('selected_nav', 'kbadminblockbycountry');
        ...
        $html = $this->module->adminDisplayWarning(
            $this->module->l('Note:: This option is not available in Free Version.', 'AdminKbBlockUserByCountryController')
        );
