...
class AdminKbBlockCustomerRequestController extends ModuleAdminController
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        $this->toolbar_title = $this->module->l('Knowband Blocked Customer Request', 'AdminKbBlockCustomerRequestController');
    }
    ...
    */
    public function initContent()
    {
        ...
        $this->context->smarty->assign('selected_nav', 'kbadminblockrequest');
        ...
        $html = $this->module->adminDisplayWarning(
            $this->module->l('Note:: This option is not available in Free Version.', 'AdminKbBlockCustomerRequestController')
        );
