<?php
/**
 * This file contains the class KbIpLocation_Url.
 *
 * PHP Version 5.0.0
 *
 * @package IpLocation
...
class KbIpLocation_Url
{
    ...
    /**
     * @var KbIpLocation_Service_Abstract The location service to use when
     ...
     * KbIpLocation_Url
     *
     * @param KbIpLocation_Service_Abstract $locationService The location service 
     *                                                     to use in this lookup.
     */
    public function __construct(KbIpLocation_Service_Abstract $locationService)
    {
     ...
     *
     * @return boolean|KbIpLocation_Results The KbIpLocation_Results results
    ...
    public function getUrlLocation($url)
    {
        ...
        $objIpLocationObject = new KbIpLocation_Ip($this->_ipLocationService);
