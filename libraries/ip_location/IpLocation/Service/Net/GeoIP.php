 ...
 *
 * <code>
 * $geoip = KbNet_GeoIP::getInstance('/path/to/geoipdb.dat', KbNet_GeoIP::SHARED_MEMORY);
 * </code>
 *
...
class KbNet_GeoIP
{
     ...
     */
    const ERR_INVALID_IP =  218624992; // crc32('KbNet_GeoIP::ERR_INVALID_IP')
    ...
    /**
     * Construct a KbNet_GeoIP instance.
    ...
    */
     ...
     * $geoip = KbNet_GeoIP::getInstance('C:\mydb.dat', KbNet_GeoIP::MEMORY_CACHE);
     * ....
     *
     * // later in code, request instance with no flags specified.
     * $geoip = KbNet_GeoIP::getInstance('C:\mydb.dat');
     *
    ...
    public static function getInstance($filename = null, $flags = null)
    {
        if (!isset(self::$instances[$filename])) {
            self::$instances[$filename] = new KbNet_GeoIP($filename, $flags);
        }
     ...
     * @param string $addr IP address (hostname not allowed).
     *
     * @return KbNet_GeoIP_Location The full location record.
     *
     * @throws PEAR_Exception - if IP address is invalid.
     */
    ...
    /**
     * Seek and populate KbNet_GeoIP_Location object for converted IP addr.
     * Note: this
     *
     * @param int $ipnum Converted IP address.
     *
     * @return KbNet_GeoIP_Location
     */
    protected function getRecord($ipnum)
    {
        ...
        $record = new KbNet_GeoIP_Location();
