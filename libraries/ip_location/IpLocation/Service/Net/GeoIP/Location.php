 ...
 * @link     http://pear.php.net/package/Net_GeoIp
 * @see      KbNet_GeoIP::lookupLocation()
 */
class KbNet_GeoIP_Location implements Serializable
{
     ...
     *
     * @param KbNet_GeoIP_Location $loc The other point to which distance will be calculated.
     *
     * @return float The number of km between two points on the globe.
     */
    public function distance(KbNet_GeoIP_Location $loc)
    {
